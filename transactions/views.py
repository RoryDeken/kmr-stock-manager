...
class PurchaseCreateView(View):                                                 
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            billdetailsobj = PurchaseBillDetail(billno=billobj)
            billdetailsobj.save()
...
class SaleCreateView(View):                                                      
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            billobj.save()     
            # create bill details object
            billdetailsobj = SaleBillDetail(billno=billobj)
            billdetailsobj.save()
            for form in formset:                                                # for loop to save each individual form as its own object
                # false saves the item and links bill to the item
                billitem = form.save(commit=False)
...
class PurchaseBillView(View):
    ...
    def get(self, request, billno):
        context = {
            ...
            'billdetails'   : PurchaseBillDetail.objects.get(billno=billno),
    ...
    def post(self, request, billno):
        ...
        if form.is_valid():
            billdetailsobj = PurchaseBillDetail.objects.get(billno=billno)
...
class SaleBillView(View):
    ...
    def get(self, request, billno):
        context = {
            ...
            'billdetails'   : SaleBillDetail.objects.get(billno=billno),
            'bill_base'     : self.bill_base,
        }
        return render(request, self.template_name, context)
    ...
    def post(self, request, billno):
        ...
        if form.is_valid():
            billdetailsobj = SaleBillDetail.objects.get(billno=billno)
